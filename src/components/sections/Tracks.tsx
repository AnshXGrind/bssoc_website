...
const tracks = [
  ...
  },
  {
    id: "03",
    title: "Systems",
    description: "Work on backend logic and architecture.",
  ...
  },
  {
    id: "04",
    title: "Open Source",
    description: "Contribute to meaningful repositories.",
...
export default function Tracks() {
  return (
    <section id="tracks" className="py-20 md:py-24 px-6 md:px-12 bg-black relative z-10 max-w-full overflow-hidden">
