...
export default function CTA() {
  ...
  return (
    <section ref={containerRef} className="py-32 px-4 md:px-12 lg:px-24 bg-[#0A0A0A] relative z-10 overflow-hidden flex flex-col items-center justify-center min-h-[80vh]">
      ...
      <div className="max-w-4xl mx-auto relative z-20 text-center">
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="group relative inline-flex items-center justify-center px-12 py-6 font-bold text-white transition-all duration-300 ease-in-out bg-accent rounded-full hover:bg-accent-blue overflow-hidden"
          >
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-between px-12 font-mono text-xs uppercase tracking-widest text-white/30">
