...
export default function Navbar() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[999] pointer-events-auto">
      <div className="flex items-center bg-black/60 backdrop-blur-md border border-white/10 text-white px-8 py-3 rounded-full shadow-lg transition-transform hover:scale-[1.02]">
